...
run_console_session() {
...

  {
    ...
    gamescope -e -f -b --force-windows-fullscreen --hide-cursor-delay 2 --adaptive-sync --immediate-flips -W "$width" -H "$height" -w "$width" -h "$height" -r "$refresh" -- steam -steamdeck -steamos3 -steampal -gamepadui
